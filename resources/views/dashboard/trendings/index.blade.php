				...
				<table class="w-full text-sm text-left rtl:text-right text-gray-500">
					...
					<tbody>
						...
						<tr class="bg-white border-b">
							<td class="px-6 py-4"><a href="{{ url("/dashboard/trendings/{$trending->id}") }}" class="text-center text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Éditer</a></td>
